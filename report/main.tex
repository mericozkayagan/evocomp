...
\author{
\IEEEauthorblockN{Group Member 1, Group Member 2, Group Member 3, Group Member 4}
\IEEEauthorblockA{Department of Computer Engineering\\Ege University, Izmir, Turkey\\Email: \{member1, member2, member3, member4\}@ogrenci.ege.edu.tr}
}
...
\textbf{Group Member 1} — Problem framing and literature review (sourced
the eight cited studies, synthesised the methodological taxonomy);
primary author of the Abstract, Introduction and Related Work sections.\par
\textbf{Group Member 2} — GA core implementation (permutation
representation, OX1/PMX crossover, tournament/roulette/rank selection,
elitism, generational replacement); primary author of the Methodology
section.\par
\textbf{Group Member 3} — Mutation operators, TSPLIB integration,
headless experiment runner, parameter sweeps across ten random seeds;
primary author of the Experimental Work section.\par
\textbf{Group Member 4} — Interactive web visualiser (live route
animation, fitness chart, control panel), end-to-end testing,
Conclusion and Future Work sections, presentation slides.\par

\noindent\textit{Note: replace these placeholder roles with the actual
division of labour before submission.}
...
Source code, raw experimental CSVs and the live visualisation are
available in the project repository at
\url{https://github.com/<group>/ec-tsp-ga}. The TSPLIB instances
